 ...
 */
export const buildToolSystemPrompt = (tools?: Tool[]): string => {
 ...
 */
export const buildPromptWithTools = (
  messages: ChatMessage[],
  tools: Tool[],
  messagesToPromptFn: (messages: ChatMessage[]) => string,
): string => {
 ...
 */
export const parseToolCallFromText = (text: string): ParsedToolCall | null => {
 ...
 */
export const toOpenAIToolCalls = (
